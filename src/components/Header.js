      ...
      <React.Fragment>
        <header className="header header-sticky mb-4">
          <div className="container-fluid">
            <button
              className="header-toggler px-md-0 me-md-3 d-none d-md-block"
              type="button"
            ...
            <button
              className="header-toggler px-md-0 me-md-3 d-md-none"
              type="button"
            ...
            <div className="header-nav d-none d-md-flex">
              <li className="nav-item">
                {this.state.greeting}, {this.props.userLoggedIn.name}
              </li>
            </div>
            ...
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb my-0 ms-2">
                <li
                  ...
                  hidden={this.props.data.title === "Dashboard"}
                >
